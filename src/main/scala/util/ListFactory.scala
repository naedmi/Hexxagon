            ...
            x match {
                case 0 => {
                    y match {
                        ...
                        case _ => List((0, y - 1), (0, y + 1), (1, ibound), (1, ibound + 1))
                    }
                }
                case MaxX => {
                    y match {
                        ...
                        case _ => List((MaxX, y - 1), (MaxX, y + 1), (MaxX - 1, ibound), (MaxX - 1, ibound + 1))
                    }
                }
                case _ => {
                    y match {
                        case 0 => {
                            if x % 2 == 1 then List((x, y + 1), (x - 1, 0), (x - 1, ibound + 1), (x + 1, 0), (x + 1, ibound + 1))
                            else List((x, y + 1), (x - 1, 0), (x + 1, 0))
                        }
                        case MaxY => List((x, y - 1), (x - 1, MaxY), (x - 1, ibound), (x + 1, MaxY), (x + 1, ibound))
